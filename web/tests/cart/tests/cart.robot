...
Documentation
...    Suite de testes destinada aos testes de carrinho

***Test Cases***
Cenário 01: Acessar carrinho
...
Cenário 05: inserir produtos na wishlist pelo carrinho e retirar
    Dado que eu esteja logado no westwing now
    Quando acessar o carrinho e inserir produtos nele
...
Cenário 14: Abrir produto pelo carrinho
    Dado que eu esteja logado no westwing now
    Quando acessar o carrinho e inserir produtos nele
    E abrir o produto pelo carrinho
    Então devo ser direcionado para a página do produto

Cenário 15: Cálculo do frete com CEP elegível NDD
    Dado que eu esteja logado no westwing now
...
Cenário 16: Cálculo do frete com CEP não elegível NDD
    Dado que eu esteja logado no westwing now
    Quando adicionar um produto que seja NDD
...
Cenário 17: Cálculo do frete quando há mais de um produto diferente no carrinho
    Dado que eu esteja logado no westwing now
